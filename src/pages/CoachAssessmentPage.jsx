...
const CoachAssessmentPage = () => {
  ...
  const { players: firestorePlayers, teams: firestoreTeams, addDocument, deleteDocument, isOnline, pendingSync, loading, errors, currentUser, userProfile } = useFilteredData();
