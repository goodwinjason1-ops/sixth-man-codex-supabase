    ...
    return (
      <div className="min-h-screen bg-[#F5F9F5] flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-800 font-medium">Loading Tryout Session...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-[#F5F9F5] flex items-center justify-center p-4">
        <div className="bg-white border border-red-500 rounded-xl p-6 text-center max-w-md">
          ...
          <h2 className="text-gray-800 font-bold text-lg mb-2">Session Not Found</h2>
          ...
          <button
            ...
            className="px-4 py-2 bg-[#D4E4D4] hover:bg-[#00A651] text-white rounded-lg"
          >
            Go Back
          </button>
        </div>
    ...
    return (
      <div className="min-h-screen bg-[#F5F9F5] flex items-center justify-center p-4">
        <div className="bg-white border border-[#D4E4D4] rounded-xl p-6 text-center max-w-md">
          ...
          <p className="text-[#00A651] mb-4">No players have been added to this session yet.</p>
          <button
            onClick={() => navigate(userProfile?.role === 'tryout_assessor' ? '/assessor' : '/admin/tryouts')}
            className="px-4 py-2 bg-[#D4E4D4] hover:bg-[#00A651] text-white rounded-lg"
          >
    ...
    <div className="min-h-screen bg-[#F5F9F5] pb-32">
      ...
      <div className="px-4 py-4">
        ...
        <div className="bg-white border border-[#D4E4D4] rounded-xl p-4 mb-4">
          <h3 className="text-gray-800 font-medium mb-3">Overall Impression</h3>
        ...
        <div className="bg-white border border-[#D4E4D4] rounded-xl p-4 mb-4">
          <HelpTooltip text="Suggest which team level this player belongs in. Coaches use these as one input for team placement.">
            <h3 className="text-gray-800 font-medium mb-3">Team Recommendation</h3>
          </HelpTooltip>
